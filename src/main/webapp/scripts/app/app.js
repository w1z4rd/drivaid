...
angular.module('drivaidApp', ['LocalStorageModule', 'tmh.dynamicLocale', 'pascalprecht.translate', 
               'ui.bootstrap', // for modal dialogs
    'ngResource', 'ui.router', 'ngCookies', 'ngAria', 'ngCacheBuster', 'ngFileUpload', 'infinite-scroll', 'angular-loading-bar', 'uiGmapgoogle-maps'])
    ...
    uiGmapGoogleMapApiProvider.configure({
        key: 'AIzaSyD8G0jnLbRoel1TzaVkYtpXQu7glboaR-I',
